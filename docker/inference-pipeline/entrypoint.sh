...
echo "🔮 Starting Inference Pipeline Service..."
echo "whoami: $(whoami)"
echo "HOME: $HOME"
...
# Check for required artifacts in S3
...
exec python3 pipelines/streaming_inference_pipeline.py
